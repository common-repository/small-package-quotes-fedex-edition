 ...
 */
    ...
    class Fedex_Small_Woo_Update_Changes 
    {
         ...
         * Get Country
         */
        function fedex_small_getCountry()
        { 
            $sCountry = "";
            switch ($this->WooVersion) 
            {  
        ...
        * @return string type
        */
        function fedex_small_getAddress1()
        { 
            $sAddress = "";
            switch ($this->WooVersion) 
            {  
