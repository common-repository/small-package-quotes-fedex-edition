...
$get_option = get_option('fedex_small_web_hook_plan_requests');
...
update_option('fedex_small_web_hook_plan_requests' , json_encode($en_web_hook_requests));
...
if($plan == '0' || $plan == '1' || $plan == '2' || $plan == '3')
{
    ...
    update_option('fedex_small_package_expire_days' , "$expire_days");
