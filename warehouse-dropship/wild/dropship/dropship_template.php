...
<script type="text/javascript">
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    <div class="en_wd_add_warehouse_input ds_input">
                        ...
                        <input type="text" title="Nickname" value="" data-optional="1" name="en_wd_dropship_nickname" placeholder="Nickname" id="en_wd_dropship_nickname" maxlength="30">
