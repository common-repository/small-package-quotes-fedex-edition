...
<script type="text/javascript">
    ...
    function change_warehouse_zip()
    {
        ...
        var zip_code = jQuery("#en_wd_origin_zip").val();
        if (zip_code && !regex_zip.test(zip_code)) {
            jQuery('.dynamic_warehouse_error').show('slow');
            jQuery('.dynamic_warehouse_error p').html('<strong>Error!</strong> Invalid Zipcode.');
            jQuery("#add_warehouses").css({'border-color': '#e81123'});
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-fedex-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
