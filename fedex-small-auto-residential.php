...
if(!class_exists("Fedex_Small_Auto_Residential_Detection"))
{
    class Fedex_Small_Auto_Residential_Detection{
        ...
        public function filter_label_sufex_array_fedex_small($result)
        {               
    ...
    new Fedex_Small_Auto_Residential_Detection();
}
