 ...
 */
if (!class_exists('EnFedExSpqOrderRates')) {

    class EnFedExSpqOrderRates
    {
        ...
        public function eniture_calculate_shipping_rates_admin()
        {
            ...
            if (get_option('enable_backup_rates_fedex_small') == 'yes' && count($prices) > 1) {
                $backup_rate_id = 'fedex_small:backup_rates';
