 ...
 * Class EnFedexSpqProductDetail
 * @package EnFedexSpqProductDetail
 */
if (!class_exists('EnFedexSpqProductDetail')) {
    ...
    class EnFedexSpqProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnFedexSpqProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_fedex_small_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_fedex_small_plan_status($plan_status)
        {
            $en_plugin_name = 'Small Package Quotes - For FedEx Customers';
            ...
            $plan_status['hazardous_material']['fedex_small'][] = 'fedex_small';
            ...
            $nesting_material = apply_filters("fedex_small_quotes_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting_material)) {
                $plan_required = '1';
                $nesting_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['fedex_small'][] = 'fedex_small';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("fedex_small_plans_notification_link", [2, 3]);
