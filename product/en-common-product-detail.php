 ...
 * Class EnFedexSpqProductCommonDetail
 * @package EnFedexSpqProductCommonDetail
 */
if (!class_exists('EnFedexSpqProductCommonDetail')) {
    ...
    class EnFedexSpqProductCommonDetail
    {
        ...
        /**
         * Hook for call.
         * EnFedexSpqProductCommonDetail constructor.
         */
        ...
        public function en_wwe_freight_plan_status($plan_status)
        {
            ...
            $insurance = apply_filters("fedex_small_quotes_plans_suscription_and_features", 'insurance_fee');
            if (is_array($insurance)) {
                $plan_required = '1';
                $insurance_status = $en_plugin_name . ': Upgrade to Standard Plan to enable.';
            }

            $plan_status['insurance']['fedex_small'][] = 'fedex_small';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['insurance'])) {
                if (!in_array(0, $plan_status['insurance']['plan_required'])) {
                    ...
                    $this->insurance_plan_required = apply_filters("fedex_small_plans_notification_link", [2, 3]);
    ...
    new EnFedexSpqProductCommonDetail();
}
