...
class EnFedExSmallFdo
{
    ...
    {
        $this->en_fdo_meta_data = [];
        $this->en_fdo_meta_data['plugin_type'] = 'small';
        $this->en_fdo_meta_data['plugin_name'] = 'fedex_small';
        $accessorials['residential'] = get_option('fedex_small_quote_as_residential_delivery') == 'yes' ? true : false;
